...
object FormLabelProvider : BaseFormProvider() {
    override fun onCreateItemView(
        ...
        setTextAppearance(R.style.FormAdapter_TextAppearance_Label)
    }
    ...
    override fun onBindItemView(
        ...
        with(holder.getView<MaterialTextView>(R.id.formInternalContent)) {
            ...
            if (itemTip?.color != null) {
                ...
                setTextColor(context.attrColor(com.google.android.material.R.attr.colorPrimary))
            }
            setPadding(
